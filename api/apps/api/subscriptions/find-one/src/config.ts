...
export const config: AWS["functions"] = {
  [subscriptionsAPI.OPERATIONS.FIND_ONE.ID]: {
    ...
    events: [
      {
        http: {
          operationId: subscriptionsAPI.OPERATIONS.FIND_ONE.NAME,
          path: subscriptionsAPI.OPERATIONS.FIND_ONE.PATH,
          method: subscriptionsAPI.OPERATIONS.FIND_ONE.METHOD,
        },
      },
    ],
  },
