...
export const config: AWS["functions"] = {
  [subscriptionsAPI.OPERATIONS.REMOVE.ID]: {
    ...
    events: [
      {
        http: {
          operationId: subscriptionsAPI.OPERATIONS.REMOVE.NAME,
          path: subscriptionsAPI.OPERATIONS.REMOVE.PATH,
          method: subscriptionsAPI.OPERATIONS.REMOVE.METHOD,
        },
      },
    ],
  },
