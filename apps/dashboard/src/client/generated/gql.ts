...
export function graphql(
  source: "query Blockchains {\n  blockchains {\n    id\n    url\n  }\n}",
): (typeof documents)["query Blockchains {\n  blockchains {\n    id\n    url\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation CreateBillingPortalSession {\n  createBillingPortalSession {\n    url\n  }\n}",
): (typeof documents)["mutation CreateBillingPortalSession {\n  createBillingPortalSession {\n    url\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation CreateCheckoutSession {\n  createCheckoutSession {\n    url\n  }\n}",
): (typeof documents)["mutation CreateCheckoutSession {\n  createCheckoutSession {\n    url\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query StripeSubscription {\n  stripeSubscription {\n    id\n    status\n  }\n}",
): (typeof documents)["query StripeSubscription {\n  stripeSubscription {\n    id\n    status\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation ActivateWebhooks($ids: [String!]!) {\n  webhookActivate(ids: $ids) {\n    count\n  }\n}",
): (typeof documents)["mutation ActivateWebhooks($ids: [String!]!) {\n  webhookActivate(ids: $ids) {\n    count\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation CreateWebhook($data: WebhookCreateInput!) {\n  webhookCreate(data: $data) {\n    id\n  }\n}",
): (typeof documents)["mutation CreateWebhook($data: WebhookCreateInput!) {\n  webhookCreate(data: $data) {\n    id\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query Webhooks($filters: WebhookFiltersInput!, $pagination: CursorPaginationInput!) {\n  webhooks(filters: $filters, pagination: $pagination) {\n    payload {\n      id\n      createdAt\n      url\n      customerId\n      blockchainId\n      isActive\n      isQueued\n      maxBlocks\n      maxRetries\n      timeoutMs\n    }\n    pagination {\n      hasNext\n      hasPrev\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation RemoveWebhooks($ids: [String!]!) {\n  webhookRemove(ids: $ids) {\n    count\n  }\n}",
): (typeof documents)["mutation RemoveWebhooks($ids: [String!]!) {\n  webhookRemove(ids: $ids) {\n    count\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation UpdateWebhook($id: String!, $data: WebhookUpdateInput!) {\n  webhookUpdate(id: $id, data: $data) {\n    count\n  }\n}",
