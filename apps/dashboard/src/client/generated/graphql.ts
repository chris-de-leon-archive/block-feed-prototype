...
export type WebhookFiltersBodyInput = {
  ...
  isActive?: InputMaybe<BoolEqFilterInput>;
...
export type BlockchainsQuery = { __typename?: 'Query', blockchains: Array<{ __typename?: 'Blockchain', id: string }> };
...
export type WebhooksQuery = { __typename?: 'Query', webhooks: { __typename?: 'Webhooks', payload: Array<{ __typename?: 'Webhook', id: string, createdAt: string, url: string, customerId: string, blockchainId: string, isActive: number, maxBlocks: number, maxRetries: number, timeoutMs: number }>, pagination: { __typename?: 'PaginationFlags', hasNext: boolean, hasPrev: boolean } } };
...
export type WebhookQuery = { __typename?: 'Query', webhook: { __typename?: 'Webhook', id: string, createdAt: string, url: string, customerId: string, blockchainId: string, isActive: number, maxBlocks: number, maxRetries: number, timeoutMs: number } };
