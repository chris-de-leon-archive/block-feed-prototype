    ...
    <LandingPageLayout>
      <section className="section bg-landing text-white">
        <div className="container mx-auto">
          <h2 className="mb-3 text-3xl">Privacy Policy</h2>
          <p className="mb-5">Last updated: March 16, 2024</p>
          <p className="mb-5">
          ...
          <h2 className="mb-5 text-2xl">Interpretation and Definitions</h2>
          <h3 className="mb-5 text-xl">Interpretation</h3>
          <p className="mb-5">
          ...
          <h3 className="mb-5 text-xl">Definitions</h3>
          <p className="mb-5">For the purposes of this Privacy Policy:</p>
          <ul className="mb-5 ml-10 list-disc [&>*]:mb-2">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to LedgerWeave Labs LLC, 20366 Via
                Sansovino, Porter Ranch, Los Angeles, California, 91326.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to BlockFeed, accessible from{" "}
                <a
                  href="https://block-feed.io"
          ...
          <h3 className="mb-5 text-xl">Types of Data Collected</h3>
          <h4 className="mb-5 text-lg">Personal Data</h4>
          <p className="mb-5">
          ...
          <h4 className="mb-5 text-lg">Usage Data</h4>
          <p className="mb-5">
          ...
          <h4 className="mb-5 text-lg">Tracking Technologies and Cookies</h4>
          <p className="mb-5">
          ...
          <h3 className="mb-5 text-xl">Use of Your Personal Data</h3>
          <p className="mb-5">
          ...
          <h3 className="mb-5 text-xl">Retention of Your Personal Data</h3>
          <p className="mb-5">
          ...
          <h3 className="mb-5 text-xl">Delete Your Personal Data</h3>
          <p className="mb-5">
          ...
          <h3 className="mb-5 text-xl">Disclosure of Your Personal Data</h3>
          <h4 className="mb-5 text-lg">Business Transactions</h4>
          <p className="mb-5">
          ...
          <h4 className="mb-5 text-lg">Law enforcement</h4>
          <p className="mb-5">
          ...
          <h4 className="mb-5 text-lg">Other legal requirements</h4>
          <p>
          ...
          <h3 className="mb-5 text-xl">Security of Your Personal Data</h3>
          <p className="mb-5">
          ...
          <h2 className="mb-5 text-2xl">Children&apos;s Privacy</h2>
          <p className="mb-5">
          ...
          <h2 className="mb-5 text-2xl">Links to Other Websites</h2>
          <p className="mb-5">
          ...
          <h2 className="mb-5 text-2xl">Changes to this Privacy Policy</h2>
          <p className="mb-5">
          ...
          <h2 className="mb-5 text-2xl">Contact Us</h2>
          <p className="mb-5">
