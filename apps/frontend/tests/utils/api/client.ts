...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CreateWebhook(variables: CreateWebhookMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateWebhookMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateWebhookMutation>(CreateWebhookDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateWebhook', 'mutation', variables);
    },
    Webhooks(variables: WebhooksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: WebhooksQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<WebhooksQuery>(WebhooksDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Webhooks', 'query', variables);
    },
    Webhook(variables: WebhookQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: WebhookQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<WebhookQuery>(WebhookDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Webhook', 'query', variables);
    },
    RemoveWebhooks(variables: RemoveWebhooksMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: RemoveWebhooksMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<RemoveWebhooksMutation>(RemoveWebhooksDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RemoveWebhooks', 'mutation', variables);
    },
    UpdateWebhook(variables: UpdateWebhookMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateWebhookMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateWebhookMutation>(UpdateWebhookDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateWebhook', 'mutation', variables);
    }
  };
}
