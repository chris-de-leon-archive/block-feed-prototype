...
DOCKER_BUILD_ARGS=(
	"-t $DOCKERHUB_USERNAME/block-feed-block-relay-rescheduling-consumer:$IMAGE_TAG --build-arg BUILD_PATH=./src/apps/rescheduling-consumer/main.go"
	...
	"-t $DOCKERHUB_USERNAME/block-feed-block-relay-block-receiver:$IMAGE_TAG --build-arg BUILD_PATH=./src/apps/block-receiver/main.go"
)
...
IMAGE_NAMES=(
	"$DOCKERHUB_USERNAME/block-feed-block-relay-rescheduling-consumer:$IMAGE_TAG"
	...
	"$DOCKERHUB_USERNAME/block-feed-block-relay-block-receiver:$IMAGE_TAG"
)
