...
IMAGE_NAMES=(
	"$DOCKERHUB_USERNAME/block-feed-block-relay-webhook-load-balancer-consumer:$IMAGE_TAG"
	"$DOCKERHUB_USERNAME/block-feed-block-relay-webhook-activation-consumer:$IMAGE_TAG"
